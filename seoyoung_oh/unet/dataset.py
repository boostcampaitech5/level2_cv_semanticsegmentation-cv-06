...
class XRayDataset_fn(Dataset):
    def __init__(self, is_train=True, transforms=None, function=None):
        _filenames = np.array(pngs)
        _labelnames = np.array(jsons)
    ...
    def __getitem__(self, item):
        ...
        image = fn.adjust_gamma(img=image, gamma=2)
...
if __name__ == '__main__':
    ...
    train_dataset = XRayDataset(is_train=False, transforms=sample_tf)
