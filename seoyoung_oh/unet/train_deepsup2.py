...
from dataset import XRayDataset_fn
...
def train(args):
    ...
    # -- dataset
    tf = transforms.Resize(512)
    
    train_dataset = XRayDataset_fn(is_train=True, transforms=tf)
    valid_dataset = XRayDataset_fn(is_train=False, transforms=tf)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--thr', type=float, default=0.4, help='valid thr')
    ...
    save_name = folder_name +  '-' + "sharpcontrastgamma"
